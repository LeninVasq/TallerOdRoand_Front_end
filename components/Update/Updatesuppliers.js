...
const Updatesuppliers = ({ visible, onClose, onSave,proveedor }) => {
...
/>
    ...
    try {
      ...
      const response = await fetch(`${API_BASE_URL}/suppliers/${proveedor.id_proveedor}`, {
        method: 'PATCH',
    ...
    <Modal visible={visible}animationType="slide" style={{ zIndex: 10 }} transparent={true}>
      <View style={styles.modalOverlay}>
        <View style={styles.modalContent}>
          <Text style={styles.modalTitle}>Actualizar proveedor</Text>

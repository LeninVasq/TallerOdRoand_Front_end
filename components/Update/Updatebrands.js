...
const Updatebrand = ({ visible, onClose, onSave, marca }) => {
...
useEffect(() => {
  if (marca) {
    ...
    setActivo(marca.estado); // Convertir "1" o "0" a booleano
...
/>
    ...
    try {
      ...
      const response = await fetch(`${API_BASE_URL}/brands/${marca.id_marca}`, {
        method: 'PATCH',
    ...
    <Modal visible={visible}animationType="slide" style={{ zIndex: 10 }} transparent={true}>
      <View style={styles.modalOverlay}>
        <View style={styles.modalContent}>
          <Text style={styles.modalTitle}>Actualizar marca</Text>

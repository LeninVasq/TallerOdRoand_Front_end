...
const Updatecompany = ({ visible, onClose, onSave,empresa }) => {
...
useEffect(() => {
  if (empresa) {
    ...
    setNit(empresa.nit || '');
    // Convierte "1" o "0" a booleano
    setActivo(empresa.estado );
  }
}, [empresa]);
...
/>
    ...
    try {
            const response = await fetch(`${API_BASE_URL}/company/${empresa.id_empresa}`, {
        method: 'PATCH',
 ...
 Estado: activo ? 1 : 0, // Convertir booleano a 1 o 0
}),
    ...
    <Modal visible={visible}animationType="slide" style={{ zIndex: 10 }} transparent={true}>
      <View style={styles.modalOverlay}>
        <View style={styles.modalContent}>
          <Text style={styles.modalTitle}>Actualizar Empresa </Text>

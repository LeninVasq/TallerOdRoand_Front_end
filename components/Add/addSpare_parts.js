...
const AddSpare_parts = ({ visible, onClose, onSave }) => {
    ...
    const handleGuardar = async () => {
        ...
        try {
          ...
          const idSubCategoria = await AsyncStorage.getItem('idsub_categorias');
            ...
            const response = await fetch(`${API_BASE_URL}/Spare_parts`, {
                method: 'POST',
                ...
                body: JSON.stringify({
                    ...
                    photo: image,
                    sub_category_id: idSubCategoria,
                }),
            });
            ...
            if (result.error_message === 'The spare parts already exists') {
                if (!isMobile) {
                    Swal.fire({
                        icon: 'error',
                        title: 'Existe',
                        text: 'El repuestoa ya existe',
                        toast: true,
                        position: 'top-end',
                        showConfirmButton: false,
                        timer: 3000,
                    ...
                    setShowAlert(true);
                    message = 'El repuestoa ya existe'
                    title = 'Existe'
                }
            } else {
                if (!isMobile) {
